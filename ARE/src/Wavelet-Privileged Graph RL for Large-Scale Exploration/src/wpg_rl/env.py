...
class Env:
    def __init__(
        ...
        self.enable_smoothness_reward = ENABLE_SMOOTHNESS_REWARD
        self.smoothness_turn_penalty = SMOOTHNESS_TURN_PENALTY
        self.smoothness_lateral_penalty = SMOOTHNESS_LATERAL_PENALTY
