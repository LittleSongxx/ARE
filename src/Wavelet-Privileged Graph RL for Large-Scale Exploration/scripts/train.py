...
from wpg_rl.parameter import RuntimeConfig, SMOKE_FOLDER_NAME, get_run_identity_from_checkpoint, resolve_resume_checkpoint
...
def main_cli():
    ...
    from wpg_rl.driver import main as driver_main
