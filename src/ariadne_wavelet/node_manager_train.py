...
from .parameter import MIN_UTILITY, NODE_RESOLUTION, SENSOR_RANGE, UTILITY_RANGE, WAVELET_SCALES
from . import quads
from .utils import (
    check_collision,
    get_frontier_in_map,
...
class NodeManager:
    ...
    def update_graph(self, robot_location, frontiers, updating_map_info, map_info):
        ...
        wavelet_map = multiscale_haar_energy_map(updating_map_info.map, scales=WAVELET_SCALES)
