...
def main():
    ...
    summary = train(config, episodes=episodes, output_dir=args.output_dir)
    print(f"checkpoint_path={summary['checkpoint']}")
    print(f"mean_explored_rate={summary['mean_explored_rate']:.4f}")
    print(f"mean_budget_violation={summary['mean_budget_violation']:.4f}")
