...
FOLDER_NAME = "large_scale_drl_exploration"
SMOKE_FOLDER_NAME = "large_scale_drl_exploration_smoke"
RUN_SESSION = ""
...
FOLDER_NAME = _env_str("LARGE_DRL_RUN_NAME", FOLDER_NAME).strip() or "large_scale_drl_exploration"
