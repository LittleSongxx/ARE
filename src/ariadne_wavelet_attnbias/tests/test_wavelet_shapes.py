...
from ariadne_wavelet_attnbias.agent import Agent
from ariadne_wavelet_attnbias.env import Env
from ariadne_wavelet_attnbias.ground_truth_node_manager import GroundTruthNodeManager
from ariadne_wavelet_attnbias.model import PolicyNet
from ariadne_wavelet_attnbias.parameter import EMBEDDING_DIM, NODE_INPUT_DIM, RuntimeConfig
from ariadne_wavelet_attnbias.utils import multiscale_haar_energy_map
from ariadne_wavelet_attnbias.worker import Worker


class Stage2WaveletShapeTests(unittest.TestCase):
    ...
    def test_ground_truth_observation_last_dim(self):
        ...
        self.assertEqual(observation[0].shape[-1], NODE_INPUT_DIM + 1)
