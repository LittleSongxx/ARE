...
def collision_check(x0, y0, x1, y1, ground_truth, robot_belief):
    ...
    while 0 <= x < ground_truth.shape[1] and 0 <= y < ground_truth.shape[0]:
        ...
        # ndarray.itemset was removed in NumPy 2.0. Direct indexing is equivalent
        # and keeps this simulator usable in both the locked server environment and
        # newer local developer environments.
